package com.aswatson.controllers;
...
public class AccountQuotaQueryTest2 {
    ...
    private static final String QUERY =
            "SELECT accountId, siebelAcctId, threshold, SUM(isUsed) as orderedAmt " +
                    ...
                    "     AND item_t2.TypePkString IN ( ? ) " + // coupon typePk list
                    "     AND (item_t3.TypePkString IS NULL OR ( item_t3.TypePkString=? ) ) " + // (x) couponredemption type
                    "     AND (item_t4.TypePkString IS NULL OR item_t4.TypePkString IN ( ? ) ) " + // users type list
                    ...
                    "     AND item_t11.TypePkString IN ( ? ) " + // products type list
                    "     AND ( " +
                    ...
                    "        AND ( item_t11.p_catalogversion IN ( ? ) ) " + // catalogVersion list
